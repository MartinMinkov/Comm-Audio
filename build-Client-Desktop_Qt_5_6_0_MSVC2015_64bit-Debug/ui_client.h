...
public:
    ...
    void setupUi(QWidget *client)
    {
        ...
        groupBox_13->setGeometry(QRect(120, 20, 241, 101));
        lineEdit_4 = new QLineEdit(groupBox_13);
        lineEdit_4->setObjectName(QStringLiteral("lineEdit_4"));
        lineEdit_4->setGeometry(QRect(42, 30, 181, 20));
        ...
        lineEdit_5->setGeometry(QRect(40, 60, 71, 20));
        groupBox_14 = new QGroupBox(tab_5);
        groupBox_14->setObjectName(QStringLiteral("groupBox_14"));
        groupBox_14->setGeometry(QRect(370, 20, 201, 101));
        label_20 = new QLabel(groupBox_14);
        label_20->setObjectName(QStringLiteral("label_20"));
        label_20->setGeometry(QRect(20, 30, 101, 16));
        QFont font;
        font.setBold(true);
        font.setWeight(75);
        ...
        pushButton_14->setGeometry(QRect(580, 20, 75, 23));
        pushButton_15 = new QPushButton(tab_5);
        pushButton_15->setObjectName(QStringLiteral("pushButton_15"));
        pushButton_15->setGeometry(QRect(580, 50, 75, 23));
        ...
        progressBar->setGeometry(QRect(102, 311, 341, 21));
        ...
        progressBar_2->setGeometry(QRect(102, 311, 341, 21));
    ...
    void retranslateUi(QWidget *client)
    {
        ...
        label_20->setText(QApplication::translate("client", "Connected", 0));
        label_21->setText(QApplication::translate("client", "Duration: 15:02:22", 0));
        pushButton_14->setText(QApplication::translate("client", "Connect", 0));
        pushButton_15->setText(QApplication::translate("client", "Disconnect", 0));
        tabWidget->setTabText(tabWidget->indexOf(tab_5), QApplication::translate("client", "Connect", 0));
        ...
        tabWidget->setTabText(tabWidget->indexOf(tab), QApplication::translate("client", "File Download", 0));
        ...
        tabWidget->setTabText(tabWidget->indexOf(tab_4), QApplication::translate("client", "File Upload", 0));
        ...
        tabWidget->setTabText(tabWidget->indexOf(tab_2), QApplication::translate("client", "Voice Chat", 0));
        ...
        tabWidget->setTabText(tabWidget->indexOf(tab_3), QApplication::translate("client", "Stream Music", 0));
    } // retranslateUi
